begin
    ...
    cwms_ts.create_ts('SPK','Alder Springs.Precip-Cumulative.Inst.15Minutes.0.raw-radar');
    cwms_ts.create_ts('SPK','Alder Springs.Precip-INC.Total.15Minutes.15Minutes.calc-radar');
    cwms_ts.create_ts('SPK','Pine Flat-Outflow.Stage.Inst.15Minutes.0.raw-radar');
    cwms_ts.create_ts('SPK','Wet Meadows.Depth-SWE.Inst.15Minutes.0.raw-radar');
