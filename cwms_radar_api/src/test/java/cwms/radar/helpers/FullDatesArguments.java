...
public class FullDatesArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        ...
        return Stream.of(
                ...
                Arguments.of("2022-01-06T07:00:00-07:00", utc,
                        ZonedDateTime.of(2022, 1, 6, 7, 0, 0, 0, utc)),
                Arguments.of("2022-01-06T07:00:00-0700", utc,
                        ZonedDateTime.of(2022, 1, 6, 7, 0, 0, 0, utc)),
                Arguments.of("2022-01-06T00:00:00", pacific,
                        // no tz in string but US/Pacific arg.  Note hour changed from 0->8
                        ZonedDateTime.of(2022, 1, 6, 8, 0, 0, 0, utc)),
                Arguments.of("2021-04-05T00:00:00", pacific,
                        // no tz in string but US/Pacific arg.  Hour changed from 0->7 b/c of timechange
                        ZonedDateTime.of(2021, 4, 5, 7, 0, 0, 0, utc)),
                Arguments.of("2019-09-07T15:50+00:00", utc,
                        // no tz but there is an offset.
                        ZonedDateTime.of(2019, 9, 7, 15, 50, 0, 0, utc)),
                Arguments.of("2021-06-10T13:00:00-07:00[PST8PDT]", utc,
                        // Has a bracket zoneId, which I think isn't strictly ISO but java likes it.
                        ZonedDateTime.of(2021, 6, 10, 13, 0, 0, 0, utc)),
                Arguments.of("2022-01-19T20:52:53+00:00[UTC]", utc,
