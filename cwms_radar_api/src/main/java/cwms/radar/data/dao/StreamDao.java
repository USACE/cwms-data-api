...
public class StreamDao extends JooqDao<Stream> {
    ...
    public Stream getStream(String streamId, String unitSystem, String officeId) throws SQLException {
        ...
        connection(dsl, c -> streamResultRef.set(streamJooq.retrieveStreamF(c, streamId,
                pStationUnit, officeId)));
    ...
    private Set<Stream> getTributaries(String streamId, String unitSystem, String officeId) throws SQLException {
        ...
        return connectionResult(dsl, c -> {
            ...
            ResultSet rs;
            rs = streamJooq.catStreams(c, null, pStationUnit, null, streamId, null, null, null,
                    null, null, null, null, null, null, null, null, null, officeId);
    ...
    private Set<Stream> buildStreamsFromResultSet(ResultSet result, String parentStreamId,
        ...
        while (result.next()) {
            ...
            if (receivingStreamId != null && receivingStreamId.equals(parentStreamId)) {
                ...
                Stream stream = new Stream.Builder(streamId, startsDownstream, streamLength,
                        officeId)
