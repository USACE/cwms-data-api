...
public class DaoTest
{
	...
	public static Connection getConnection() throws SQLException
	{
		...
		String url = System.getenv("CDA_JDBC_URL" );
		String user = System.getenv("CDA_JDBC_USERNAME" );
		String password = System.getenv("CDA_JDBC_PASSWORD");

		assertNotNull(url, "CDA_JDBC_URL should have been set in the Environment Variables");
		assertNotNull(user, "CDA_JDBC_USERNAME should have been set in the Environment Variables");
		assertNotNull(password, "CDA_JDBC_PASSWORD should have been set in the Environment Variables");
