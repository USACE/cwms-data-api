begin
  ...
  cwms_sec.add_user_to_group('l2webtest','CWMS Users', 'HQ');
  cwms_sec.add_user_to_group('l2webtest','CWMS PD Users', 'HQ');
  cwms_sec.add_user_to_group('l2webtest','CWMS DBA Users', 'HQ');
  cwms_sec.add_user_to_group('l2webtest','CWMS Users', 'SPK');
  cwms_sec.add_user_to_group('l2webtest','CWMS PD Users', 'SPK');
  cwms_sec.add_user_to_group('l2webtest','CWMS DBA Users', 'SPK');
